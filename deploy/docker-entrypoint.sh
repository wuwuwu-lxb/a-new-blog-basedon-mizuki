...
trap "echo '[Entry] Received SIGTERM, shutting down...'; kill $ASTRO_PID 2>/dev/null; exit 0" SIGTERM SIGINT

# 等待进程退出
wait $ASTRO_PID
EXIT_CODE=$?

echo "[Entry] Process exited with code $EXIT_CODE, stopping all services..."
